...
$(document).ready(function () {
    ...
    $(".add-project").on("click", function () {
        ...
        let newProject = $(`
        <div class="row goal-rating-div-${goalId}${incrementValue}">
                    <div class="col-xxl-9">
                        <div class="card mb-4">
                            <div class="card-body card-body-goal">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <h5>
                                            <span class="heading-color">Goal Rating</span> 
                                            <span class="bi bi-dash-circle-fill pointer text-primary ms-2 remove-project" data-goal-id="${goalId}" data-project-count="${incrementValue}"></span>
    ...
    $(document).on("click", ".remove-project", function (event) {
        ...
        let goalId = $(this).data("goal-id"); 
        let projectId = $(this).data("project-count");
        $('.goal-rating-div-'+goalId+projectId).remove();
    });
